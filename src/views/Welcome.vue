    ...
    <div class="flex-1 flex flex-col items-center justify-center px-6 w-full max-w-md mx-auto space-y-12">
      ...
      <div class="text-center space-y-6">
        ...
        <div class="space-y-3">
          ...
          <p class="text-slate-500 font-medium text-lg tracking-wide">
            探索亲密关系的源代码
          </p>
        </div>
      </div>
        ...
        <div class="w-full">
          ...
          <div class="relative min-h-[160px]">
            ...
            <div v-if="activeTab === 'dual'" class="space-y-4 animate-fade">
              <div class="relative">
                <input v-model="myCode" placeholder="你的代码" class="w-full h-12 bg-white border border-slate-200 rounded-xl px-4 text-base font-mono focus:outline-none focus:border-black focus:ring-1 focus:ring-black transition-all placeholder:text-slate-300" />
              ...
              <div class="relative">
                <input v-model="partnerCode" placeholder="伴侣的代码" class="w-full h-12 bg-white border border-slate-200 rounded-xl px-4 text-base font-mono focus:outline-none focus:border-black focus:ring-1 focus:ring-black transition-all placeholder:text-slate-300" />
